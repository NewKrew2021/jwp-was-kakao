...
public class WebAcceptanceTest {
    ...
    void loginSuccess() {
        ...
        assertThat(response.statusCode()).isEqualTo(HttpStatus.FOUND.value());
        assertThat(response.cookies().get(Cookie.SESSION)).isNotNull();
    }
    ...
    void loginFail() {
        ...
        assertThat(response.statusCode()).isEqualTo(HttpStatus.FOUND.value());
        assertThat(response.cookies().get(Cookie.SESSION)).isEqualTo(null);
    }
    ...
    void userListSuccess() {
        ...
        ExtractableResponse<Response> response = 사용자_리스트_요청(path, loginResponse.cookie(Cookie.SESSION));
        assertThat(response.statusCode()).isEqualTo(HttpStatus.OK.value());
    ...
    private ExtractableResponse<Response> 사용자_리스트_요청(String path, String sessionId) {
        return RestAssured.
                given().log().all().cookie(Cookie.SESSION, sessionId).
                when().get(path).
                then().log().all().
